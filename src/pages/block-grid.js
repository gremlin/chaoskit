...
const BlockGridDocs = () => (
  <FoundationLayout pageTitle="BlockGrid">
    ...
    <Alert type="warning" title="Note‍" className="u-mb--regular">
      <p>There should be no whitespace modifiers attached to <code>.blockGrid</code> or its direct children. You can attach them on adjacent DOM or by wrapping the component in a <code>&lt;div&gt;</code></p>
    </Alert>

    <Live
      code={BlockGridExample}
    ...
    <p>You can change the spacing in-between each block with the following modifiers to <code>.blockGrid</code></p>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>
            <code>.blockGrid--collapse</code><br />
        ...
        <tr>
          <td>
            <code>.blockGrid--largeGutter</code><br />
        ...
        <tr>
          <td>
            <code>.blockGrid--xlargeGutter</code><br />
    ...
    <p>You can chain these classes together for unique widths based on our global breakpoints: <code>.blockGrid-8@small blockGrid-6@medium blockGrid-4@large</code>.</p>

    <Alert type="warning" title="Note" className="u-mb--regular">
      Block Grids automatically have a width of <code>100%</code> when broken down to the smallest breakpoint unless specified (like <code>.blockGrid-4</code>); so <code>.blockGrid-12</code> is not needed.
    </Alert>
