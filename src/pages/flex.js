...
const FlexDocs = () => (
  <BaseLayout pageTitle="Flex">
    <p>
      We take advantage of Flexbox for many of our components; so it made sense
      for us to expose a number of utilities as well.
    </p>

    <h3>Deep match</h3>

    <p>
      While flex children automatically recieve the same height, children&apos;s
      children (where you may actually have your styling) does not. Use the{' '}
      <code>.u-flexDeepMatch</code> modifier attached to <code>.row</code> to
      resolve this.
    </p>
