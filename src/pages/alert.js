...
() => {
  ...
  return (
    <Fragment>
      <div><Button onClick={() => setCollapse(!isCollapsed)} type="secondary">Toggle Alert</Button></div>
      <Alert
      ...
      <div><Button onClick={() => setCollapse2(!isCollapsed2)} type="secondary">Toggle Alert</Button></div>
      <Alert
